...
import { fmtCompact, fmtKES, fmt } from "@/lib/admin-utils";
    ...
    <>
      ...
      <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <KPI
          ...
          hint={`${fmt(stats.activeUsers)} active`}
        />
        <KPI
      ...
      <section className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <AdminCard title="Quick stats">
          <ul className="space-y-3 text-sm">
            ...
            <Row label="Active Jobs" value={fmt(stats.activeJobs)} />
            <Row label="Funded Businesses" value={fmt(stats.fundedBusinesses)} />
            <Row label="Open Tickets" value={fmt(stats.openTickets)} />
          </ul>
        </AdminCard>
      </section>
