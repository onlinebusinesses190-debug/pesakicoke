    ...
    <>
      ...
      {stats && (
        <section className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <KPI
            label="Active Jobs"
            value={fmt(stats.activeJobs)}
            hint="+12% this week"
            tone="success"
          />
          <KPI label="Workers Listed" value={fmt(stats.workersListed)} hint="Verified profiles" />
          <KPI
            label="Hires This Month"
            value={fmt(stats.hiresThisMonth)}
            hint="Completed contracts"
            tone="gold"
          />
          <KPI
            label="Flagged Listings"
            value={fmt(stats.flaggedListings)}
            hint="Needs review"
            tone="destructive"
          />
        </section>
