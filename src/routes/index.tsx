...
function HomePage() {
  ...
  // Refresh the Home balance after a successful deposit/withdraw/transfer.
        ...
        <section className="-mt-5 px-5">
          <Card className="grid grid-cols-4 gap-2">
            ...
            >
              ...
              <span className="text-[11px] font-medium">Trading</span>
            </button>
          </Card>
        </section>
              ...
              opportunities.map((o) => (
                <Card key={o.title} className="!p-3.5">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <Badge
                      tone={
                        o.tag === "Urgent" ? "destructive" : o.tag === "Hot" ? "warning" : "gold"
                      }
                    >
                      {o.tag}
                    </Badge>
