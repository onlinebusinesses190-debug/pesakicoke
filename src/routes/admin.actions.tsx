    ...
    <>
      ...
      {stats && (
        <section className="grid grid-cols-2 gap-4 lg:grid-cols-3">
          <KPI label="Total actions" value={stats.total_actions.toLocaleString()} hint="All time" />
          <KPI
            label="Today"
            value={stats.today_actions.toLocaleString()}
            hint="24h rolling"
            tone="gold"
          />
          <KPI
            label="Active admins"
            value={stats.unique_admins.toLocaleString()}
            hint="Past 24h"
            tone="success"
          />
        </section>
